exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
    ...
    VALUES (${client.global.escapeDB(client.global.createID(30))}, ${client.global.escapeDB(args[0].toProperCase())}, ${client.global.escapeDB(args[2])}, ${date}, ${client.global.escapeDB(args[1])})`)
